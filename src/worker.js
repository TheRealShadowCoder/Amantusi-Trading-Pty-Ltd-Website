...
function enhanceLayout(response, { admin = false } = {}) {
  ...
  const publicStyles = admin ? '' : '<link rel="stylesheet" href="/cinematic.css"><link rel="stylesheet" href="/motion-plus.css"><link rel="stylesheet" href="/animation-registry.css"><link rel="stylesheet" href="/animation-3d-overlay.css"><link rel="stylesheet" href="/performance-v3.css">';
  const publicScripts = admin ? '' : '<script src="/cinematic.js" defer></script><script src="/motion-plus.js" defer></script><script src="/animation-registry.js" defer></script><script src="/animation-3d-overlay.js" defer></script><script src="/performance-v3.js" defer></script>';
